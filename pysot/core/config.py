...
__C.DATASET.DET = CN()
__C.DATASET.DET.ROOT = 'train_dataset/hsi/crop511'           # DET dataset path
__C.DATASET.DET.ANNO = 'train_dataset/hsi/train.json'
__C.DATASET.DET.FRAME_RANGE = 1
__C.DATASET.DET.NUM_USE = -1

__C.DATASET.GOT = CN()
__C.DATASET.GOT.ROOT = 'train_dataset/hsi/crop511'         # GOT dataset path
__C.DATASET.GOT.ANNO = 'train_dataset/hsi/train.json'
